...
class ApprovalView(discord.ui.View):
    ...
    async def decide(self, interaction: discord.Interaction, approved: bool) -> None:
        ...
        if not footer.startswith("member:"): return await interaction.response.send_message("Invalid approval record.", ephemeral=True)
        ...
        await self.database.set_verification_status(interaction.guild.id, member_id, status)
