...
# ── Whitelist: ONLY current channels (legacy REMOVED) ──
_KEEP_CATEGORIES = {
...
_KEEP_TEXT = {
    ...
    "📁-mission-briefs", "🏆-leaderboards",
    "📊-surveillance-logs", "🔐-approval-queue", "👁️-control-panels",
    "🧪-dev-terminal", "👑-vip-lounge", "🎨-art-gallery",
    "🎵-music-lab", "📺-stream-deck", "🚪-departure-terminal",
}
...
async def _clean_layout(guild: discord.Guild) -> None:
    """Delete every channel/role/category NOT in the current layout."""
    me = guild.me
...
async def _full_reset(guild: discord.Guild) -> None:
    """NUCLEAR: Delete every channel and bot role, then rebuild."""
    me = guild.me
    if not me or not me.guild_permissions.manage_channels or not me.guild_permissions.manage_roles:
